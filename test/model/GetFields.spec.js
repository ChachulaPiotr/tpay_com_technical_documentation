...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.GetFields();
  });
  ...
  describe('GetFields', function() {
    it('should create an instance of GetFields', function() {
      // uncomment below and update the code to test GetFields
      //var instane = new TpayComTechnicalDocumentation.GetFields();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.GetFields);
    });

    it('should have the property title (base name: "title")', function() {
      // uncomment below and update the code to test the property title
      //var instance = new TpayComTechnicalDocumentation.GetFields();
