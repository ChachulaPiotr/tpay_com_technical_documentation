...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.SellerDataObject();
  });
  ...
  describe('SellerDataObject', function() {
    it('should create an instance of SellerDataObject', function() {
      // uncomment below and update the code to test SellerDataObject
      //var instane = new TpayComTechnicalDocumentation.SellerDataObject();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.SellerDataObject);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TpayComTechnicalDocumentation.SellerDataObject();
