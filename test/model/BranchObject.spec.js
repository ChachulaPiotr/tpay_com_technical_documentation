...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.BranchObject();
  });
  ...
  describe('BranchObject', function() {
    it('should create an instance of BranchObject', function() {
      // uncomment below and update the code to test BranchObject
      //var instane = new TpayComTechnicalDocumentation.BranchObject();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.BranchObject);
    });

    it('should have the property bId (base name: "b_id")', function() {
      // uncomment below and update the code to test the property bId
      //var instance = new TpayComTechnicalDocumentation.BranchObject();
