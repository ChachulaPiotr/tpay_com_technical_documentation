...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.ReportResponse();
  });
  ...
  describe('ReportResponse', function() {
    it('should create an instance of ReportResponse', function() {
      ...
      //var instane = new TpayComTechnicalDocumentation.ReportResponse();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.ReportResponse);
    });

    it('should have the property result (base name: "result")', function() {
      // uncomment below and update the code to test the property result
      //var instance = new TpayComTechnicalDocumentation.ReportResponse();
