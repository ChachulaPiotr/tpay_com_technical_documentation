...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.MasspaymentPacksFields();
  });
  ...
  describe('MasspaymentPacksFields', function() {
    it('should create an instance of MasspaymentPacksFields', function() {
      // uncomment below and update the code to test MasspaymentPacksFields
      //var instane = new TpayComTechnicalDocumentation.MasspaymentPacksFields();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.MasspaymentPacksFields);
    });
    ...
    it('should have the property packId (base name: "pack_id")', function() {
      ...
      //var instance = new TpayComTechnicalDocumentation.MasspaymentPacksFields();
