...
(function(root, factory) {
  ...
  describe('CardsErrCode', function() {
    it('should create an instance of CardsErrCode', function() {
      // uncomment below and update the code to test CardsErrCode
      //var instane = new TpayComTechnicalDocumentation.CardsErrCode();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.CardsErrCode);
    });
