...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.PresaleFields();
  });
  ...
  describe('PresaleFields', function() {
    it('should create an instance of PresaleFields', function() {
      // uncomment below and update the code to test PresaleFields
      //var instane = new TpayComTechnicalDocumentation.PresaleFields();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.PresaleFields);
    });

    it('should have the property desc (base name: "desc")', function() {
      // uncomment below and update the code to test the property desc
      //var instance = new TpayComTechnicalDocumentation.PresaleFields();
