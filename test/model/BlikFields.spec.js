...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.BlikFields();
  });
  ...
  describe('BlikFields', function() {
    it('should create an instance of BlikFields', function() {
      // uncomment below and update the code to test BlikFields
      //var instane = new TpayComTechnicalDocumentation.BlikFields();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.BlikFields);
    });

    it('should have the property title (base name: "title")', function() {
      // uncomment below and update the code to test the property title
      //var instance = new TpayComTechnicalDocumentation.BlikFields();
