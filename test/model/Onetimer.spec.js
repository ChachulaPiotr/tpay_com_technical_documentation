...
(function(root, factory) {
  ...
  describe('Onetimer', function() {
    it('should create an instance of Onetimer', function() {
      // uncomment below and update the code to test Onetimer
      //var instane = new TpayComTechnicalDocumentation.Onetimer();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.Onetimer);
    });
