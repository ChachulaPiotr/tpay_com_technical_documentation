...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.VcPrepareFields();
  });
  ...
  describe('VcPrepareFields', function() {
    it('should create an instance of VcPrepareFields', function() {
      // uncomment below and update the code to test VcPrepareFields
      //var instane = new TpayComTechnicalDocumentation.VcPrepareFields();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.VcPrepareFields);
    });
    ...
    it('should have the property apiPassword (base name: "api_password")', function() {
      ...
      //var instance = new TpayComTechnicalDocumentation.VcPrepareFields();
