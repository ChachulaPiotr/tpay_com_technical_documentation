...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.RefundAnyFields();
  });
  ...
  describe('RefundAnyFields', function() {
    it('should create an instance of RefundAnyFields', function() {
      // uncomment below and update the code to test RefundAnyFields
      //var instane = new TpayComTechnicalDocumentation.RefundAnyFields();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.RefundAnyFields);
    });

    it('should have the property title (base name: "title")', function() {
      // uncomment below and update the code to test the property title
      //var instance = new TpayComTechnicalDocumentation.RefundAnyFields();
      //expect(instance).to.be();
    });

    it('should have the property chargebackAmount (base name: "chargeback_amount")', function() {
