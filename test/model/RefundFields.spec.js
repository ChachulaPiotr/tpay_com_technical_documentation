...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.RefundFields();
  });
  ...
  describe('RefundFields', function() {
    it('should create an instance of RefundFields', function() {
      // uncomment below and update the code to test RefundFields
      //var instane = new TpayComTechnicalDocumentation.RefundFields();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.RefundFields);
    });
    ...
    it('should have the property cliAuth (base name: "cli_auth")', function() {
      ...
      //var instance = new TpayComTechnicalDocumentation.RefundFields();
