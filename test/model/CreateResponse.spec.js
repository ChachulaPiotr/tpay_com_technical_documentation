...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.CreateResponse();
  });
  ...
  describe('CreateResponse', function() {
    it('should create an instance of CreateResponse', function() {
      ...
      //var instane = new TpayComTechnicalDocumentation.CreateResponse();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.CreateResponse);
    });

    it('should have the property result (base name: "result")', function() {
      // uncomment below and update the code to test the property result
      //var instance = new TpayComTechnicalDocumentation.CreateResponse();
