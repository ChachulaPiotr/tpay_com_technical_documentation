...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.SaleFields();
  });
  ...
  describe('SaleFields', function() {
    it('should create an instance of SaleFields', function() {
      // uncomment below and update the code to test SaleFields
      //var instane = new TpayComTechnicalDocumentation.SaleFields();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.SaleFields);
    });
    ...
    it('should have the property cliAuth (base name: "cli_auth")', function() {
      ...
      //var instance = new TpayComTechnicalDocumentation.SaleFields();
