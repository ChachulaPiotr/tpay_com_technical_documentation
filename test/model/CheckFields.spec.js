...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.CheckFields();
  });
  ...
  describe('CheckFields', function() {
    it('should create an instance of CheckFields', function() {
      // uncomment below and update the code to test CheckFields
      //var instane = new TpayComTechnicalDocumentation.CheckFields();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.CheckFields);
    });
    ...
    it('should have the property apiPassword (base name: "api_password")', function() {
      ...
      //var instance = new TpayComTechnicalDocumentation.CheckFields();
