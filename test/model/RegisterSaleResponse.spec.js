...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.RegisterSaleResponse();
  });
  ...
  describe('RegisterSaleResponse', function() {
    it('should create an instance of RegisterSaleResponse', function() {
      // uncomment below and update the code to test RegisterSaleResponse
      //var instane = new TpayComTechnicalDocumentation.RegisterSaleResponse();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.RegisterSaleResponse);
    });

    it('should have the property result (base name: "result")', function() {
      // uncomment below and update the code to test the property result
      //var instance = new TpayComTechnicalDocumentation.RegisterSaleResponse();
