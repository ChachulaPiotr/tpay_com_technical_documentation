...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TpayComTechnicalDocumentation.DeregisterFields();
  });
  ...
  describe('DeregisterFields', function() {
    it('should create an instance of DeregisterFields', function() {
      // uncomment below and update the code to test DeregisterFields
      //var instane = new TpayComTechnicalDocumentation.DeregisterFields();
      //expect(instance).to.be.a(TpayComTechnicalDocumentation.DeregisterFields);
    });
    ...
    it('should have the property cliAuth (base name: "cli_auth")', function() {
      ...
      //var instance = new TpayComTechnicalDocumentation.DeregisterFields();
